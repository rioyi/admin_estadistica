...
<div class="alert alert-success" role="alert">
  ...
  SE HA MODIFICADO EXITOSAMENTE</font>
      ...
      <div class="alert alert-warning" role="alert">¡ESTA INFORMACIÓN PODRA CONSULTARLA EN LA SECCIÓN DE DOCENTE!</div>
      ...
      <a href="../forms/form_docente.php">
        <button type="button" class="btn btn-success  btn-lg">
          <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> IR A DOCENTE
        </button>
      </a>
