...
<div class="alert alert-success" role="alert">
  ...
  SE HA REGISTRADO EXITOSAMENTE</font>
      ...
      <div class="alert alert-warning" role="alert">¡ESTA INFORMACIÓN PODRA CONSULTARLA EN LA SECCIÓN DE DOCENTES!</div>
      ...
      <a href="../forms/form_docente.php">
        <button type="button" class="btn btn-success  btn-lg">
          <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> IR A DOCENTES
        </button>
      </a>
